        ...
        <td height='100%' valign='top' background='images/fondo_cuerpo.gif'>
            <form name='form1' action='index.php?a=1' method='post'>
                ...
                <table width='300' border=0 align=center cellpadding='2' cellspacing='1' bgcolor='#FFFFFF'>
                    ...
                    <tr bgcolor='EEF2F4'>
                        <td colspan='2' align='center' bgcolor='#EFF3F7'><input type='submit' name='aceptar'
                                                                                value='Aceptar' class='input'></td>
                    </tr>
                    </tr>
                </table>
                <p align='center'><b><a href="ingresarcv.php">Desea ingresar su curriculum como un usuario nuevo</a></b>
                </p>
                <? if ($mal == '1') { ?>
