...
<input type="text" name="bus_localidad" value="<?echo $bus_localidad?>" size="40">
</td>
</tr>
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Provincia:</td>
<td width="75%" bgcolor="#EFEFEF"> 
<input type="text" name="bus_provincia" value="<?echo $bus_provincia?>" size="40">
</td>
</tr>
<tr> 
...
<?for($j=0;$j<count($veci);$j++){?>
	<input type="checkbox" name="bus_idiomas[]" value="<?=$veci[$j][0]?>"><?=$veci[$j][1];?>
	&nbsp;&nbsp;&nbsp;
<?}?>
</td>
</tr>
...
<?for($j=0;$j<count($vech);$j++){?>
	<input type="checkbox" name="bus_herramientas[]" value="<?=$vech[$j][0]?>"><?=$vech[$j][1];?>
	&nbsp;&nbsp;&nbsp;
<?}?>
</td>
</tr>
...
<td width="75%" bgcolor="#EFEFEF"> 
<input type='TEXT' name='bus_estado_civil' value='<?php echo $bus_estado_civil; ?>' size='50' maxlength='45'>
</td>
</tr>
...
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Posee movilidad propia:</td>
<td width="75%" bgcolor="#EFEFEF"> 
...
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Tiene que tener celular:</td>
<td width="75%" bgcolor="#EFEFEF"> 
...
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Tiene Nivel de estudios / Estado:</td>
<td width="75%" bgcolor="#EFEFEF"> 
...
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Tiene Terciario o Universitario / Estados:</td>
<td width="75%" bgcolor="#EFEFEF"> 
...
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Tiene Disponibilidad para viajar:</td>
<td width="75%" bgcolor="#EFEFEF"> 
...
<tr> 
<td width="25%" bgcolor="#F5FCFF" class="itemformulario">Antecedentes Laborales:</td>
<td width="75%" bgcolor="#EFEFEF"> 
...
&nbsp;&nbsp;&nbsp;
<a href="#" onclick="document.frm_buscar.exportar.value='1';document.frm_buscar.submit()">Exportar</a>
</td>
</tr>
...
<br>
							...
							<tr> 
								<td bgcolor='#999999'> 
									<table width='558' border='0' cellspacing='0' cellpadding='0'>
										<tr>	<td width='180' background='images/fondo_tabl.gif' class='textolistado'>
				<span class='textolistado'><b><font color='#999999'>&nbsp;codigo</font></b></span>
			</td>
			<td width='1' bgcolor='#999999'>
				<img src='images/1x1.gif' width='1' height='1'>
			</td>	<td width='180' background='images/fondo_tabl.gif' class='textolistado'>
			...
			<td width='1' bgcolor='#999999'>
				<img src='images/1x1.gif' width='1' height='1'>
			</td> <td width='51' background='images/fondo_tabl_borrar.gif'>
		...
		$pijama=$pijama*(-1)?> 
			<tr height='20'>	<td style='padding: 5px' class='textolistado' height='20' bgcolor='<?if($pijama<1){?>#ffffff<?}else{?>#f7f7f7<?}?>'> 
				...
				<td width='1' bgcolor='#999999' height='20'></td>	<td style='padding: 5px' class='textolistado' height='20' bgcolor='<?if($pijama<1){?>#ffffff<?}else{?>#f7f7f7<?}?>'> 
					<a href='modificar_curriculums.php?codigo=<?echo strtolower($rs['codigo'])?>' class='textolistado'><?echo $rs['apellido']?></a>
				</td> 
				<td width='1' bgcolor='#999999' height='20'></td>	<td style='padding: 5px' class='textolistado' height='20' bgcolor='<?if($pijama<1){?>#ffffff<?}else{?>#f7f7f7<?}?>'> 
					<a href='modificar_curriculums.php?codigo=<?echo strtolower($rs['codigo'])?>' class='textolistado'><?echo $rs['nombre']?></a>
				</td> 
				<td width='1' bgcolor='#999999' height='20'></td>	<td style='padding: 5px' class='textolistado' height='20' bgcolor='<?if($pijama<1){?>#ffffff<?}else{?>#f7f7f7<?}?>'> 
					<a href='modificar_curriculums.php?codigo=<?echo strtolower($rs['codigo'])?>' class='textolistado'><?echo $rs['edad']?></a>
				</td> 
				<td width='1' bgcolor='#999999' height='20'></td>	<td style='padding: 5px' class='textolistado' height='20' bgcolor='<?if($pijama<1){?>#ffffff<?}else{?>#f7f7f7<?}?>'> 
				<a href='set_curriculums_activo.php?codigo=<?echo strtolower($rs['codigo'])?>&activo=<?php echo $rs['estado']?>' class='textolistado'><?if($rs['estado']==0){echo 'Invisible';}else{echo 'Activo';}?></a>
			</td> 
			<td width='1' bgcolor='#999999' height='20'></td>	<td style='padding: 5px' class='textolistado' height='20' bgcolor='<?if($pijama<1){?>#ffffff<?}else{?>#f7f7f7<?}?>'> 
					<a href='modificar_curriculums.php?codigo=<?echo strtolower($rs['codigo'])?>' class='textolistado'><?echo $rs['usuario']?></a>
				</td> 
				<td width='1' bgcolor='#999999' height='20'></td>		<td width='51' align='center' height='20' bgcolor='<?if ($pijama<0){?>#ffffff<?}else{?>#f7f7f7<?}?>'>
				<a href='borrar_curriculums.php?codigo=<?echo $rs['codigo']?>' onclick='return verify();'><img src='images/ico_borrar.gif' width='12' height='12' border='0'></a>
			</td>
			</tr>
			<?}?> 					
								</table>
