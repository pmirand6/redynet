 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://ias.redynet.com.ar/phpadmin';
...
$cfg['Servers'][$i]['user']          = 'ftpias';      // MySQL user
$cfg['Servers'][$i]['password']      = 'jaPKRQpHJFmaXD4j';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'ftpias';          // If set to a db-name, only
