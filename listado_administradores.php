...
<tr> 
<td valign="center">
<a href="modificar_administradores.php"><img src="images/bot_alta.gif" border="0" vspace="3"></a>
</td></tr>
</table>
...
<span class="textolistado"><b><font color="#999999">&nbsp;Apellido</font></b></span></td>
<td width="1" bgcolor="#999999"><img src="images/1x1.gif" width="1" height="1"></td>

<td width="180" background="images/fondo_tabl.gif" class="textolistado">
<span class="textolistado"><b><font color="#999999">&nbsp;Nombre</font></b></span></td>
<td width="1" bgcolor="#999999"><img src="images/1x1.gif" width="1" height="1"></td>

<td width="70" background="images/fondo_tabl.gif" class="textolistado">
<span class="textolistado"><b><font color="#999999">&nbsp;Estado</font></b></span></td>
<td width="1" bgcolor="#999999"><img src="images/1x1.gif" width="1" height="1"></td>

<td width="51" background="images/fondo_tabl_borrar.gif"><img src="images/tit_borrar.gif" width="51" height="17"></td>
...
<td style="padding: 5px" class="textolistado" height="20" bgcolor="<?php if ($pijama< 1){?>#ffffff<?php } else { ?>#f7f7f7<?php } ?>"> 
<a href="modificar_administradores.php?codigo=<?php echo $rs["codigo"]?>&" class="textolistado"><?php echo $rs["apellido"]?> 
</a></td> 
<td width="1" bgcolor="#999999" height="20"></td> 

<td style="padding: 5px" class="textolistado" height="20" bgcolor="<?php if ($pijama< 1){?>#ffffff<?php } else { ?>#f7f7f7<?php } ?>"> 
<a href="modificar_administradores.php?codigo=<?php echo $rs["codigo"]?>&" class="textolistado"><?php echo $rs["nombre"]?> 
</a></td> 
<td width="1" bgcolor="#999999" height="20"></td> 

<td style="padding: 5px" class="textolistado" height="20" bgcolor="<?php if ($pijama< 1){?>#ffffff<?php } else { ?>#f7f7f7<?php } ?>"> 
<a href="set_administradores_activo.php?codigo=<?php echo $rs["codigo"]?>&activo=<?php echo $rs["estado"]?>" class="textolistado"><?php if ($rs["estado"]==0){ echo "Invisible"; } else{ echo "Activo"; }?> 
</a></td> 
<td width="1" bgcolor="#999999" height="20"></td> 

<td width="51" align="center" height="20" bgcolor="<?php if ($pijama<0) { ?>#ffffff<?php } else { ?>#f7f7f7<?php } ?>">
<a href="borrar_administradores.php?codigo=<?php echo $rs["codigo"]?>" onclick="return verify();"><img src="images/ico_borrar.gif" width="12" height="12" border="0"></a></td>
