    ...
    <tr>
        ...
        <td align='left' valign='top' width='560' background='images/fondo_cuerpo.gif'>
            ...
            <TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
                <form enctype='multipart/form-data' action='grabar_curriculums.php?codigo=<? echo $codigo ?>'
                      method='POST' name='frm_curriculums' id='frm_curriculums'>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='tipo_doc' value='<?php echo $tipo_doc; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='documento' value='<?php echo $documento; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='nacionalidad' value='<?php echo $nacionalidad; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ccnumero' value='<?php echo $ccnumero; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input value='<? echo $fecha_nac ?>' name='fecha_nac' type='text' class='cajas'
                                   onFocus='this.style.backgroundColor="#B7DDD9"'
                                   onBlur='this.style.backgroundColor="#ffffff"' maxlength='10' size='12'></td>
                    </tr>
                    <tr>
                        <td width='25%' bgcolor='#F5FCFF' class='itemformulario'>
                            Lugar de Nacimiento:
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='lugar_nac' value='<?php echo $lugar_nac; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='estado_civil' value='<?php echo $estado_civil; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='telefono' value='<?php echo $telefono; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='localidad' value='<?php echo $localidad; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='provincia' value='<?php echo $provincia; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='nombre_conyugue' value='<?php echo $nombre_conyugue; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='nombre_madre' value='<?php echo $nombre_madre; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='nombre_padre' value='<?php echo $nombre_padre; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                ...
                <? for ($j = 0; $j < count($veci); $j++) {
                    ...
                    <tr>
                        <td bgcolor='#F5FCFF' class='itemformulario'><b><?= $veci[$j][1] ?></b>
                            <? if ($veci[$j][1] == "Otros") { ?><input type="text" name="idiomaotros"
                                                                       value="<?= QueOtros($codigo, 0, $veci[$j][0], $conn) ?>"
                                                                       size="20"><? } ?>
                        </td>
                        <? for ($k = 0; $k < count($vecn); $k++) { ?>
                            <td bgcolor='#F5FCFF' class='itemformulario'>
                                <input type="radio" <? if ($vnivel == $vecn[$k][0]) echo "checked" ?>
                                       name="idioma<?= $veci[$j][0] ?>" value="<?= $vecn[$k][0] ?>">
                            </td>
                        <? } ?>
                    </tr>
                <? } ?>
                ...
                <? for ($j = 0; $j < count($vech); $j++) {
                    ...
                    <tr>
                        <td bgcolor='#F5FCFF' class='itemformulario'><b><?= $vech[$j][1] ?></b>
                            <? if ($vech[$j][1] == "Otros") { ?><input type="text" name="herramientaotros"
                                                                       value="<?= QueOtros($codigo, $vech[$j][0], 0, $conn) ?>"
                                                                       size="20"><? } ?>
                        </td>
                        <? for ($k = 0; $k < count($vecn); $k++) { ?>
                            <td bgcolor='#F5FCFF' class='itemformulario'>
                                <input type="radio" <? if ($vnivel == $vecn[$k][0]) echo "checked" ?>
                                       name="herramienta<?= $vech[$j][0] ?>" value="<?= $vecn[$k][0] ?>">
                            </td>
                        <? } ?>
                    </tr>
                <? } ?>
            ...
            <TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
                ...
                $r = mysqli_query($conn, $cons);
                while (($rs = mysqli_fetch_array($r)) || $j < 2) {
                    if ($rs) {
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <!--<input type='TEXT' name='tcestado<? //=$j
                            ?>' value='<? //php echo $tcestado;
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='titulo<?= $j ?>' value='<?php echo $titulo; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='inicio<?= $j ?>' value='<?php echo $inicio; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='final<?= $j ?>' value='<?php echo $final; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='institucion<?= $j ?>' value='<?php echo $institucion; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='donde<?= $j ?>' value='<?php echo $donde; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='fecha_desde<?= $j ?>' value='<?php echo $fecha_desde; ?>' size='50'
                                   maxlength='50'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='fecha_hasta<?= $j ?>' value='<?php echo $fecha_hasta; ?>' size='50'
                                   maxlength='50'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='numero_matricula<?= $j ?>' value='<?php echo $numero_matricula; ?>'
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='lugar_mat<?= $j ?>' value='<?php echo $lugar_mat; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='localidad_ejer<?= $j ?>' value='<?php echo $localidad_ejer; ?>'
            ...
            <TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
                ...
                while (($rs = mysqli_fetch_array($r)) || $j < 2) {
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <!--<input type='TEXT' name='ecestado<? //=$j
                            ?>' value='<? //php echo $ecestado;
                            ?>' size='50' maxlength='45'>-->
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ectitulo<?= $j ?>' value='<?php echo $ectitulo; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ecinicio<?= $j ?>' value='<?php echo $ecinicio; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ecfinal<?= $j ?>' value='<?php echo $ecfinal; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ecinstitucion<?= $j ?>' value='<?php echo $ecinstitucion; ?>'
                                   size='50' maxlength='45'>
                        </td>
                    </tr>
            ...
            <TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
                ...
                $r = mysqli_query($conn, $cons);
                while (($rs = mysqli_fetch_array($r)) || $j < 5) {
                    if ($rs) {
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='empresa<?= $j ?>' value='<?php echo $empresa; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='domicilio<?= $j ?>' value='<?php echo $domicilio; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ultima_area<?= $j ?>' value='<?php echo $ultima_area; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='ingreso<?= $j ?>' value='<?php echo $ingreso; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='egreso<?= $j ?>' value='<?php echo $egreso; ?>' size='50'
                                   maxlength='45'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='puesto<?= $j ?>' value='<?php echo $puesto; ?>' size='50'
                                   maxlength='100'>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <textarea name='causa_egreso<?= $j ?>' cols='47'
                                      rows='4'><? echo $causa_egreso ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td width='25%' bgcolor='#F5FCFF' class='itemformulario'>
                        ...
                        <td width='75%' bgcolor='#EFEFEF'>
                            <input type='TEXT' name='personal_cargo<?= $j ?>' value='<?php echo $personal_cargo; ?>'
                                   size='50' maxlength='100'>
                        </td>
                    </tr>
                    <tr>
            ...
            <TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
                <tr bgcolor='EEF2F4' align='center' valign='middle'>
                    <td colspan='2' height='41' width='558'>
                        <a href='javascript:validar()'><img src='images/bot_grabar.gif' width='63' height='18'
                                                            border='0'></a>
                    </td>
                </tr>
                </form>
