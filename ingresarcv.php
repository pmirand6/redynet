...
if(isset($_SESSION['usrcode']))$codigo = $_SESSION['usrcode'];
...
function validar(){  //validacion del formulario 
	...
	if (d.apellido.value=='') 
			...
			if (d.tipo_doc.value=='') 
			{error+='* tipo_doc debe ser completado\n'};
			...
			{error+='* fecha_nac debe ser completado\n'};
			if (d.lugar_nac.value=='') 
			{error+='* lugar_nac debe ser completado\n'};
			if (d.edad.value==''){
			...
			{error+='* estado_civil debe ser completado\n'};
			if (d.usuario.value=='') 
...
<?if(isset($_SESSION['usrcode'])){?>
<table width='700' border='0' cellpadding='0' cellspacing='0'>
	<tr>
		<td valign='top'>Hola: <?=$_SESSION['usrname']?></td>
		<td valign='top'><a href="ingresarcv.php">Volver a mis datos</a></td>
		<td valign='top'><a href="index.php?cerrar=t">Cerrar Sesion</a></td>
	</tr>
</table>
<br><br>
<?}?>
...
<?if($ok==1){?>
<span class=titulo>Sus datos fueron actulziados con exito.</span><br>
<a href="index.php">Ingresar con mis datos.</a>
<?}?>

<?if($ok==0){?>
<span class=titulo>Alta / Modificacion de curriculums</span><br>

			<form enctype='multipart/form-data' action='grabar_curriculums.php?codigo=<?echo $codigo?>' method='POST' name='frm_curriculums' id='frm_curriculums'>
			<TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
				...
				<tr> 
					...
					<td width='75%' bgcolor='#EFEFEF'> 
						<input value='<?echo $fecha_nac?>' name='fecha_nac' type='text' maxlength='10' size='12'></td>
				</tr><tr> 
					<td width='25%' bgcolor='#F5FCFF' class='itemformulario'>
						Lugar de Nacimiento:
					</td>
			...
			<TABLE WIDTH='560' CELLPADDING='2' CELLSPACING='1' BORDER='0' BGCOLOR='#999999'>
				<tr bgcolor='EEF2F4' align='center' valign='middle'> 
					<td colspan='2' height='41' width='558'>
						<a href='javascript:validar()'>Grabar</a>
					</td>
				</tr>
			</table>
		</form>
